    ...
    <div class="container-fluid mt-2">
        <div class="row">
            <div class="col-lg-3 mt-2">
                <div class="card">
                    <h6 class="bg-danger p-2 text-white text-center text-">Vehicle Entry</h6>
                    <div class="card-body">
                        <form action="index.php" method="post">
                            ...
                            <div class="form-group">
                                <input type="submit" class="btn btn-success btn-sm" name="send">
                                <input type="reset" class="btn btn-danger btn-sm" name="clear" value="clear">
                            </div>
                        </form>
                    </div>
                </div>
